...
const { processImportsField } = require("../../source/enhanced-resolve/lib/util/entrypoints");
const ResolverFactory = require("../../source/enhanced-resolve/lib/ResolverFactory");
const CachedInputFileSystem = require("../../source/enhanced-resolve/lib/CachedInputFileSystem");

/** @typedef {import("../../source/enhanced-resolve/lib/util/entrypoints").ImportsField} ImportsField */
